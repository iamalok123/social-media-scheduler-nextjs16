...
-- Description: Core tables, seed data, RLS, and custom JWT function
--              for the social media scheduler app (Clerk + InsForge)
...
-- ── channel_types (seeded lookup table) ───────────────────────────────────────
...
-- ── idea_groups (seeded lookup table) ─────────────────────────────────────────
