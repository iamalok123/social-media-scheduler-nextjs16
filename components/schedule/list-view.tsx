...
const ListView = ({
            ...
            },
            {
                ...
                queryFn: async () => {
                    ...
                    const res = await fetch(
                        `/api/post/totals?${params.toString()}`,
                    );
    ...
    return (
        <>
                            ...
                            <div className="flex h-full flex-col items-center justify-center text-center">
                                <div className="max-w-sm space-y-4">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Connect a channel and create your first
                                        post to get started with scheduling.
                                    </p>
                                    <Button
                                        size="lg"
                                        onClick={() =>
                        ...
                        lg:grid-cols-[120px_minmax(0,1fr)]"
                                ...
                                <span>{post.status === "draft" ? "Draft" : "Custom"}</span>
                                                        ...
                                                        <Card className="py-0 gap-0">
                                                            <CardContent
                                                                className="grid gap-6 p-5 md:grid-cols-[minmax(0,1fr)_250px]"
                                                            >
                                                                <div className="space-y-5">
                                                                    ...
                                                                    <p
                                                                        className="whitespace-pre-wrap text-sm leading-6 line-clamp-4 "
                                                                    >
                                                                        {
                                                                            post.content
                                                                        }
                                                                ...
                                                                <div
                                                                    className="max-h-41.25 overflow-hidden rounded-2xl border bg-muted/40"
                                                                >
                                                                    {previewImage ? (
                                                                        <Image
                                                                            src={
            ...
            <EditPostDialog
                key={`${isEditDialogOpen ? "open" : "closed"}-${selectedPostForEdit?.id ?? "none"}`}
                ...
                post={
                    selectedPostForEdit
                        ? {
                              ...
                              userChannelId:
                                  selectedPostForEdit.user_channel_id || "",
                              channel: selectedPostForEdit.user_channels
                                  ?.channel_types
                                  ? {
                                        ...selectedPostForEdit.user_channels
                                            .channel_types,
                                        profile_image:
                                            selectedPostForEdit.user_channels
                                                .profile_image,
                                        handle: selectedPostForEdit
                                            .user_channels.handle,
                                    }
                                  : null,
                          }
                        : null
