...
type PostCalendarEvent = PostType & {
    title: string;
    start: Date;
    end: Date;
};
...
export function PostCalendar({
    ...
    const formats = React.useMemo(
        () => ({
            ...
            dayFormat: (date: Date) => format(date, "EEEE d"),
        }),
        [],
    );
    ...
    return (
        <div
            className={cn(
                "h-full relative flex flex-col min-h-150 bg-background",
            )}
        >
            <Calendar<PostCalendarEvent>
                ...
                onView={(v) =>
                    onViewChange(v === Views.MONTH ? "month" : "week")
                }
                onSelectEvent={(event) => onPostClick(event)}
                ...
                dayPropGetter={(date: Date) => {
                    ...
                    return {
                        className: isPastDate
                            ? "bg-[#331f000f]! pointer-events-none"
                            : "",
                        style: isPastDate
                        ...
                        date: Date;
                            ...
                            return (
                                <>
                                    ...
                                    {isPending && (
                                        <Skeleton className="h-8 w-11/12 m-2 my-5" />
                                    )}
                                </>
                            );
                        },
