...
const CreatePostDialog = ({ open, onOpenChange, selectedDate }: PropsType) => {
    ...
    const channels = useMemo(() => {
        ...
        return ((channelsData || []) as ChannelType[]).map((channel) => ({
            ...channel,
    ...
    const handleGlobalContentChange = (
        text: string,
        images?: ImageObject[],
    ) => {
    ...
    return (
        ...
        . It will be copied to channels when you select them"
                                            ...
                                            onChange={(text) =>
                                                handleGlobalContentChange(text)
                                            }
                    ...
                    {hasConnectedChannel ? (
                        ...
                        >
                            <Button
                                ...
                                onClick={() =>
                                    handleCreatePost(POST_STATUS.DRAFT)
                                }
                            >
